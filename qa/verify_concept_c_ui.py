...
check("Concept C compact footprint", "setSize (940, 540)" in editor_cpp)
...
check("Inline circular Learn workflow", "LearnCircleButton" in editor_h and "startNoiseLearn" in editor_cpp)
check("Learn popup removed", "LearnPopup" not in editor_h and "drawLearnPopup" not in editor_cpp)
check("Frozen profile feedback", 'mainText = "Profile Active"' in editor_cpp and '"CAPTURED NOISE PROFILE"' in editor_cpp and '"Denoise active  ·  frozen noise profile"' in editor_cpp)
