...
check("Advanced has real control plus profile diagnostics", "Profile quality" in advanced and "Analysis quality" in advanced and "Latency" in advanced and ("DSP ceiling" in advanced or "DSP CEILING" in advanced))
...
check("P5.1 Advanced drawer has collision-safe geometry", "shouldShow ? 704 : 540" in cpp and "{ 15, 538, 910, 150 }" in cpp)
